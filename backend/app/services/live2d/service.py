...
class Live2DService(ILive2DService):
    ...
    async def list_models(self) -> List[Dict[str, Any]]:
        ...
        try:
                            ...
                            models.append(
                                {
                                    ...
                                    "thumbnail": (
                                        f"/static/live2d/{model_dir}/thumbnail.png"
                                        if os.path.exists(
                                            os.path.join(model_path, "thumbnail.png")
                                        )
                                        else None
                                    ),
                                }
            ...
            raise HTTPException(
                status_code=500, detail=f"Failed to list Live2D models: {str(e)}"
            )
    ...
    async def get_model(self, model_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            if not os.path.exists(model_json_path):
                raise HTTPException(
                    status_code=404, detail="Model configuration not found"
                )
            ...
            return {
                ...
                "thumbnail": (
                    f"/static/live2d/{model_id}/thumbnail.png"
                    if os.path.exists(os.path.join(model_path, "thumbnail.png"))
                    else None
                ),
            }
            ...
            raise HTTPException(
                status_code=500, detail=f"Failed to retrieve Live2D model: {str(e)}"
            )
    ...
    async def upload_model(
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail=f"Failed to upload Live2D model: {str(e)}"
            )
    ...
    async def delete_model(self, model_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail=f"Failed to delete Live2D model: {str(e)}"
            )

    async def animate(
        self, model_id: str, motion_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail=f"Failed to animate Live2D model: {str(e)}"
            )
    ...
    async def get_settings(self, user_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail=f"Failed to retrieve Live2D settings: {str(e)}"
            )
    ...
    async def update_settings(
        ...
        try:
            ...
            raise HTTPException(
                status_code=500, detail=f"Failed to update Live2D settings: {str(e)}"
            )
