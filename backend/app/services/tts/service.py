...
class TTSService(ITTSService):
    ...
    async def get_voice(self, voice_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail=f"Failed to retrieve voice: {str(e)}")
    ...
    async def get_settings(self, user_id: int) -> Dict[str, Any]:
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail=f"Failed to retrieve TTS settings: {str(e)}")
