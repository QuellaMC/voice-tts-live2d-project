...
class CompanionService(BaseService[Companion, CompanionCreate, CompanionUpdate], ICompanionService):
    ...
    async def list_companions(self, user_id: int, skip: int = 0, limit: int = 100) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail=f"Failed to list companions: {str(e)}")
    ...
    async def update_companion(self, companion_id: int, update_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            ...
            # Update companion
            updated_companion = await super().update(self.db, db_obj=companion, obj_in=companion_in)
    ...
    async def chat_with_companion(self, companion_id: int, message: str, chat_history: Optional[List[Dict[str, str]]] = None) -> Dict[str, Any]:
        ...
        try:
            ...
            raise HTTPException(status_code=500, detail=f"Failed to chat with companion: {str(e)}")
