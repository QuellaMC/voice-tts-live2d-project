...
class Concept(Base):
    ...
    knowledge_entries = relationship('Knowledge', secondary=knowledge_concepts, back_populates='concepts')
...
class User(Base):
    ...
    role: UserRole = Column(SQLAlchemyEnum(UserRole), nullable=False, default=UserRole.USER)
    is_active: bool = Column(Boolean, nullable=False, default=True)
    created_at: datetime = Column(DateTime, nullable=False, default=datetime.utcnow)
    last_login: Optional[datetime] = Column(DateTime, nullable=True)

    # Relationships
    groups: List["UserGroup"] = relationship("UserGroup", secondary="user_group_members", back_populates="users")
    audit_logs: List["KnowledgeAudit"] = relationship("KnowledgeAudit", back_populates="user")
...
class Knowledge(Base):
    ...
    tags: List["Tag"] = relationship("Tag", secondary=knowledge_tags, back_populates="knowledge_entries", cascade="all, delete")
    concepts: List["Concept"] = relationship("Concept", secondary=knowledge_concepts, back_populates="knowledge_entries", cascade="all, delete")
    audit_logs: List["KnowledgeAudit"] = relationship("KnowledgeAudit", back_populates="knowledge", cascade="all, delete")
...
class Tag(Base):
    ...
    # Relationships
    knowledge_entries = relationship('Knowledge', secondary=knowledge_tags, back_populates='tags')
...
User.groups = relationship('UserGroup', secondary='user_group_members', back_populates='users')
