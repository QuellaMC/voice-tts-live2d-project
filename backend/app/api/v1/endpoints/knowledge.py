...
from app.services import KnowledgeService, KnowledgeBatchService, TagService, ConceptService
...
async def cleanup_knowledge_base(
    ...
    background_tasks.add_task(
        KnowledgeService().cleanup_old_entries,
        db=db,
        days=days
    )
    background_tasks.add_task(
        KnowledgeBatchService().cleanup_orphaned,
        db=db
    )
...
async def reindex_embeddings(
    ...
    background_tasks.add_task(
        KnowledgeBatchService().reindex_embeddings,
        db=db,
