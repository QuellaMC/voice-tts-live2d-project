...
from app.schemas.user import UserCreate, UserInDB, UserList, UserResponse, UserUpdate
...
async def list_users(
    ...
    users = await UserService().get_multi(db, skip=skip, limit=limit, filters=filters)
...
@router.post("/login")
async def login(email: str, password: str, db: Session = Depends(get_db)) -> dict:
